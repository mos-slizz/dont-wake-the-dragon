...
3. **Silence test.** During the heist, everyone genuinely holds still for 15 s. The meter should sit near the bottom. If it creeps up on its own, the "Dragon hearing" setting on the TV lobby (Chill / Normal / Hardcore) is too high for your phones.
...
Debug keys on the TV: `space`/`enter` = Next, `d` = fake a noisy lookout for one tick.
...
- **Stage 1 (this):** core loop, 2 Thief tasks, 6-heist ladder, awards.
